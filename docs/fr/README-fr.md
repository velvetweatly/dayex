...
Vous trouverez plus de détails sur l'API et les autres documents sur le site [dayex.org](https://dayex.org/).
...
📚[Guide d'installation](https://dayex.org/docs/en/installation/installation)
...
📚[Internationalisation](https://dayex.org/docs/en/i18n/i18n)
...
📚[Liste des plugins](https://dayex.org/docs/en/plugin/plugin)
