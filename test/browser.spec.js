...
describe('Install', function () {
  it('window.dayex ', function () {
    if (!window.dayex) throw new Error('No window.dayex')
  })
})

describe('Core APIs', function () {
  it('Chain Methods', function () {
    expect(dayex('2011-02-05T14:48:00.000Z')
      .clone()
      .set('month', 3)
      .set('second', 30)
      .endOf('month')
  ...
  it('Date parse - nonstandard date string', function () {
    expect(dayex('2018-4-1 1:1:1:22').format('YYYY-MM-DD hh:mm:ss'))
      .toBe('2018-04-01 01:01:01')
    expect(dayex('2018-4-1').format('YYYY-MM-DD hh:mm:ss'))
      .toBe('2018-04-01 12:00:00')
    expect(dayex('2018-4-1 11:49').format('YYYY-MM-DD hh:mm:ss')) // fix ios bug
