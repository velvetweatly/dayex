...
import dayex from '../../src/index'
import isBetween from '../../src/plugin/isBetween/index'

dayex.extend(isBetween)
...
test('bounds can be swapped', () => {
  expect(dayex('2018-01-01').isBetween(dayex('2017-12-31'), dayex('2018-01-02'))).toBeTruthy()
  expect(dayex('2018-01-01').isBetween(dayex('2018-01-02'), dayex('2017-12-31'))).toBeTruthy()
})

test('bounds can be swapped with inclusivity', () => {
  expect(dayex('2018-01-01').isBetween(dayex('2017-12-31'), dayex('2018-01-01'), null, '[]')).toBeTruthy()
  expect(dayex('2018-01-01').isBetween(dayex('2018-01-01'), dayex('2017-12-31'), null, '[]')).toBeTruthy()
})

test('is between without units', () => {
  const m = dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  const mCopy = dayex(m)

  expect(m.isBetween(
    dayex(new Date(2009, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'year is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2013, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'year is earlier')

  expect(m.isBetween(
    dayex(new Date(2010, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2012, 3, 2, 3, 4, 5, 10))
  )).toBe(true, 'year is between')

  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'month is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 5, 2, 3, 4, 5, 10))
  )).toBe(false, 'month is earlier')

  expect(m.isBetween(
    dayex(new Date(2011, 2, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 4, 2, 3, 4, 5, 10))
  )).toBe(true, 'month is between')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 1, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'day is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 4, 3, 4, 5, 10))
  )).toBe(false, 'day is earlier')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 1, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 3, 3, 4, 5, 10))
  )).toBe(true, 'day is between')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 1, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'hour is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 5, 4, 5, 10))
  )).toBe(false, 'hour is earlier')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 2, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 4, 4, 5, 10))
  )).toBe(true, 'hour is between')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 6, 5, 10))
  )).toBe(false, 'minute is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 2, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'minute is earlier')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 3, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 5, 5, 10))
  )).toBe(true, 'minute is between')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 7, 10))
  )).toBe(false, 'second is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 3, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'second is earlier')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 4, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 6, 10))
  )).toBe(true, 'second is between')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 12))
  )).toBe(false, 'millisecond is later')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 8)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 10))
  )).toBe(false, 'millisecond is earlier')

  expect(m.isBetween(
    dayex(new Date(2011, 3, 2, 3, 4, 5, 9)),
    dayex(new Date(2011, 3, 2, 3, 4, 5, 11))
...
test('is between year', () => {
  const m = dayex(new Date(2011, 1, 2, 3, 4, 5, 6))
  const mCopy = dayex(m)

  expect(m.isBetween(
    dayex(new Date(2011, 5, 6, 7, 8, 9, 10)),
    dayex(new Date(2011, 5, 6, 7, 8, 9, 10)),
    'year'
  )).toBe(false, 'year match')

  expect(m.isBetween(
    dayex(new Date(2010, 5, 6, 7, 8, 9, 10)),
    dayex(new Date(2012, 5, 6, 7, 8, 9, 10)),
    'years'
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 5, 6, 7, 8, 9, 10)),
    dayex(new Date(2013, 5, 6, 7, 8, 9, 10)),
    'year'
  )).toBe(false, 'year is earlier')
...
test('is between month', () => {
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 1, 6, 7, 8, 9, 10)),
    dayex(new Date(2011, 1, 6, 7, 8, 9, 10)),
    'month'
  )).toBe(false, 'month match')

  expect(m.isBetween(
    dayex(new Date(2011, 0, 6, 7, 8, 9, 10)),
    dayex(new Date(2011, 2, 6, 7, 8, 9, 10)),
    'months'
  )).toBe(true, 'plural should work')

  expect(m.isBetween(
    dayex(new Date(2011, 0, 31, 23, 59, 59, 999)),
    dayex(new Date(2011, 2, 1, 0, 0, 0, 0)),
    'month'
  )).toBe(true, 'month is between')
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 11, 6, 7, 8, 9, 10)),
    dayex(new Date(2011, 1, 6, 7, 8, 9, 10)),
    'month'
  )).toBe(false, 'month is later')
...
test('is between day', () => {
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 7, 8, 9, 10)),
    dayex(new Date(2011, 1, 2, 7, 8, 9, 10)),
    'day'
  )).toBe(false, 'day match')

  expect(m.isBetween(
    dayex(new Date(2011, 1, 1, 7, 8, 9, 10)),
    dayex(new Date(2011, 1, 3, 7, 8, 9, 10)),
    'days'
  )).toBe(true, 'plural should work')
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 7, 8, 9, 10)),
    dayex(new Date(2011, 1, 4, 7, 8, 9, 10)),
    'day'
  )).toBe(false, 'day is earlier')
...
test('is between hour', () => {
  ...
  const mCopy = dayex(m)
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 5, 9, 10)),
    dayex(new Date(2011, 1, 2, 3, 9, 9, 10)), 'hour'
  ))
    .toBe(false, 'hour match')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 1, 59, 59, 999)),
    dayex(new Date(2011, 1, 2, 4, 0, 0, 0)), 'hours'
  ))
    .toBe(true, 'plural should work')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 2, 59, 59, 999)),
    dayex(new Date(2011, 1, 2, 4, 0, 0, 0)), 'hour'
  ))
    .toBe(true, 'hour is between')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 7, 8, 9, 10)),
    dayex(new Date(2011, 1, 2, 7, 8, 9, 10)), 'hour'
  ))
    .toBe(false, 'hour is earlier')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 7, 8, 9, 10)),
...
test('is between minute', () => {
  ...
  const mCopy = dayex(m)
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 9, 10)),
    dayex(new Date(2011, 1, 2, 3, 4, 9, 10)), 'minute'
  ))
    .toBe(false, 'minute match')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 3, 9, 10)),
    dayex(new Date(2011, 1, 2, 3, 5, 9, 10)), 'minutes'
  ))
    .toBe(true, 'plural should work')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 3, 59, 999)),
    dayex(new Date(2011, 1, 2, 3, 5, 0, 0)), 'minute'
  ))
    .toBe(true, 'minute is between')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 5, 0, 0)),
    dayex(new Date(2011, 1, 2, 3, 8, 9, 10)), 'minute'
  ))
    .toBe(false, 'minute is earlier')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 2, 9, 10)),
    dayex(new Date(2011, 1, 2, 3, 3, 59, 999)), 'minute'
  ))
    .toBe(false, 'minute is later')
...
test('is between second', () => {
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 5, 10)),
    dayex(new Date(2011, 1, 2, 3, 4, 5, 10)), 'second'
  ))
    .toBe(false, 'second match')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 4, 10)),
    dayex(new Date(2011, 1, 2, 3, 4, 6, 10)), 'seconds'
  ))
    .toBe(true, 'plural should work')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 4, 999)),
    dayex(new Date(2011, 1, 2, 3, 4, 6, 0)), 'second'
  ))
    .toBe(true, 'second is between')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 6, 0)),
    dayex(new Date(2011, 1, 2, 3, 4, 7, 10)), 'second'
  ))
    .toBe(false, 'second is earlier')
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 3, 10)),
    dayex(new Date(2011, 1, 2, 3, 4, 4, 999)), 'second'
  ))
    .toBe(false, 'second is later')
...
test('is between millisecond', () => {
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 5, 6)),
    dayex(new Date(2011, 1, 2, 3, 4, 5, 6)),
    'millisecond'
  )).toBe(false, 'millisecond match')

  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 5, 5)),
    dayex(new Date(2011, 1, 2, 3, 4, 5, 7)),
    'milliseconds'
  )).toBe(true, 'plural should work')
  ...
  expect(m.isBetween(
    dayex(new Date(2011, 1, 2, 3, 4, 5, 4)),
    dayex(new Date(2011, 1, 2, 3, 4, 5, 6)),
    'millisecond'
  )).toBe(false, 'millisecond is later')
...
test('is between without units inclusivity', () => {
  ...
  expect(m.isBetween(
    ...
    null,
    '()'
  )).toBe(false, 'start and end are excluded, start is equal to dayex')
  ...
  expect(m.isBetween(
    ...
    null,
    '()'
  )).toBe(false, 'start and end are excluded, end is equal to dayex')
