...
it('Add Time days (DST)', () => {
  ...
  // New Zealand (-720)
  expect(dayex('2018-04-01').add(1, 'd').format()).toBe(moment('2018-04-01').add(1, 'd').format())
  expect(dayex('2018-03-28').add(1, 'w').format()).toBe(moment('2018-03-28').add(1, 'w').format())
  // London (-60)
  expect(dayex('2018-10-28').add(1, 'd').format()).toBe(moment('2018-10-28').add(1, 'd').format())
  expect(dayex('2018-10-26').add(1, 'w').format()).toBe(moment('2018-10-26').add(1, 'w').format())
})
...
it('UTC and utcOffset', () => {
  ...
  expect(dayex(test1).utcOffset(-300).format())
    .toBe(moment(test1).utcOffset(-300).format())
  const test2 = '2000-01-01T06:31:00Z'
  expect(dayex.utc(test2).utcOffset(-60).format())
...
it('UTC diff in DST', () => {
  // DST till 2020-10-25
  const day1 = dayex.utc('20201023') // in DST
  const day2 = dayex.utc('20201026')
