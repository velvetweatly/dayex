...
describe('issue 2027 - order objectSupport > Duration', () => {
  it('add Duration object returns correct date', () => {
    const baseDate = dayex('2022-06-26T14:01:02.003')
    const durationToAdd = dayex.duration(6, 'hours')
